...
from .tokenization import load_vocab, BasicTokenizer, WordpieceTokenizer
...
class FullTokenizer(object):
    ...
    def __init__(self, bert_path, do_lower_case=True):
        self.vocab = None
        print("load vocab")
        self.vocab = load_vocab(os.path.join(bert_path, 'vocab_chinese.txt'))
        print("load token")
        self.basic_tokenizer = BasicTokenizer(do_lower_case=do_lower_case, never_split=(
            "[UNK]", "[SEP]", "[PAD]", "[CLS]", "[MASK]", "[USR]", "[SVR]"
        ))
...
class AlbertModel(AlbertPreTrainedModel):
    ...
    def _resize_token_type_embeddings(self, new_num_tokens):
